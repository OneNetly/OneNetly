            ...
            <div class="relative group md:w-6/12 lg:w-7/12">
                ...
                <div class="relative p-6 pt-16 md:p-8 md:pl-12 md:rounded-r-2xl lg:pl-20 lg:p-16">
                    ...
                    <div class="mt-6 flex justify-between gap-6">
                        <img class="w-16 lg:w-24" src="./img/partners/cpanel.png" loading="lazy" alt="cPanel">
                        <img class="w-16 lg:w-24" src="./img/partners/Imunify360.png" loading="lazy" alt="Imunify360">
                        <img class="w-16 lg:w-24" src="./img/partners/cloudlinux.png" loading="lazy" alt="Cloudlinux">
                    </div>
                </div>
            </div>
        </div>
